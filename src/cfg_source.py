...
FALLBACK_CONFIG = {
    ...
    "categories": [
        ...
        {"name": "手机", "descs": ["一部智能手机", "手机的背面和摄像头", "一部正面亮屏的手机", "一块带摄像头的手机后盖", "手机"], "negative": False},
        ...
        {"name": "平板电脑", "descs": ["平板电脑", "平板", "iPad", "横向的大屏幕", "一块横放的平板电脑", "平板电脑的背面和摄像头"], "negative": False},
        {"name": "笔记本电脑", "descs": ["笔记本电脑", "一台笔记本电脑", "笔记本电脑的顶盖", "闭合的笔记本电脑",
                    "笔记本电脑的金属外壳", "带键盘的笔记本电脑"], "negative": False},
