...
DEFAULT_CONFIG = {
    ...
    "preload": True,
    "categories": [
        {"name": "身份证", "descs": ["身份证", "一张身份证", "居民身份证", "卡面上印着中华人民共和国居民身份证"], "negative": False},
        {"name": "驾驶证", "descs": ["驾驶证", "驾照", "机动车驾驶证", "黑色封皮的驾驶证", "墨绿色封皮的驾驶证",
                    "驾驶证的内页", "封皮上的字是机动车驾驶证"], "negative": False},
        {"name": "行驶证", "descs": ["行驶证", "机动车行驶证", "车辆行驶证", "蓝色封皮的行驶证", "一本蓝色的行驶证",
                    "封皮上的字是机动车行驶证"], "negative": False},
        {"name": "银行卡", "descs": ["一张银行卡", "银行卡的正面", "一张带芯片的银行卡", "银行卡背面",
                    "一张银行卡的芯片面", "带卡通图案的银行卡"], "negative": False},
        {"name": "公交卡", "descs": ["公交卡", "交通卡", "公交IC卡"], "negative": False},
        {"name": "票据", "descs": ["票据", "收据", "发票", "纸质票据"], "negative": False},
        {"name": "现金", "descs": ["现金", "纸币", "钞票", "一叠钞票", "人民币", "硬币", "一把硬币",
                    "一枚硬币", "一枚金色的纪念币"], "negative": False},
        {"name": "手机", "descs": ["手机", "一部智能手机", "背面有多个大摄像头的手机", "细长的手机",
                    "一部正面亮屏的手机", "手机背面的大摄像头"], "negative": False},
        ...
        {"name": "平板电脑", "descs": ["平板电脑", "平板", "iPad", "背面有摄像头的平板电脑",
                    "平板电脑背面有一个摄像头和一个标志", "平板电脑背面的圆形摄像头"], "negative": False},
        {"name": "笔记本电脑", "descs": ["笔记本电脑", "闭合的笔记本电脑", "没有摄像头的笔记本电脑顶盖",
                    "顶盖上只有一个品牌标志的笔记本电脑", "笔记本电脑的金属外壳"], "negative": False},
        {"name": "U盘", "descs": ["U盘", "闪存盘", "USB存储设备"], "negative": False},
        {"name": "电子烟", "descs": ["电子烟", "笔状的电子烟杆", "细长的电子烟", "带烟嘴的电子烟"], "negative": False},
        {"name": "香烟", "descs": ["一包香烟", "一盒香烟", "未拆封的香烟盒", "一条香烟", "香烟包装盒"], "negative": False},
        {"name": "打火机", "descs": ["打火机", "一次性打火机", "带金属防风罩的打火机",
                    "红色塑料壳的打火机", "长方形的打火机"], "negative": False},
        {"name": "钱包", "descs": ["钱包", "皮钱包", "钱夹", "带拉链的皮质钱包"], "negative": False},
        ...
        {"name": "手链手镯", "descs": ["手链", "手镯", "一串手链", "戴在手腕上的手镯", "一个圆环形的玉镯", "粗圆环手镯"], "negative": False},
        ...
        {"name": "笔", "descs": ["笔", "圆珠笔", "一支笔", "细长的笔杆", "带笔夹的笔", "一支原子笔"], "negative": False},
        {"name": "本子", "descs": ["本子", "一本记事本", "纸质记事本", "带扣的记事本"], "negative": False},
        {"name": "剪刀", "descs": ["剪刀", "一把剪刀", "小剪刀"], "negative": False},
        {"name": "纸巾", "descs": ["纸巾", "一包纸巾", "抽纸"], "negative": False},
        {"name": "水杯", "descs": ["一个水杯", "一个保温杯", "一个带盖的杯子", "一只饮水杯", "透明的水杯",
                    "细长的圆筒形水杯", "带盖的保温杯"], "negative": False},
        {"name": "雨伞", "descs": ["雨伞", "折叠伞", "一把伞"], "negative": False},
        {"name": "梳子", "descs": ["梳子", "一把梳子"], "negative": False},
        {"name": "镜子", "descs": ["镜子", "小镜子", "手持镜子", "带手柄的圆形镜子", "圆形的化妆镜"], "negative": False},
        {"name": "指甲刀", "descs": ["指甲刀", "指甲剪", "指甲剪的杠杆压片", "指甲钳的弧形刀口", "小型的指甲剪",
                    "小巧的金属指甲刀"], "negative": False},
        {"name": "药品", "descs": ["药品", "药盒", "一板药片", "药瓶"], "negative": False},
        {"name": "护肤化妆", "descs": ["护肤品", "化妆品", "一支口红", "圆形的粉饼盒", "气垫粉饼", "化妆品的小盒子"], "negative": False},
